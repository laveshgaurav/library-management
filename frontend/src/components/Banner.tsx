...
function Banner({ username }: Props) {
  return (
    <div className="border-red w-full p-8">
      <div className="flex gap-x-8 md:flex-col md:gap-y-6">
        <div className="bg-red flex aspect-[4/1] w-1/2 items-center justify-between rounded-md p-8 md:w-full md:p-4">
          <div className="flex h-full w-full flex-col justify-between">
            <div className="">
              <h2 className="text-24 mb-2 font-normal text-white">
        ...
        <div className="aspect-[5/2] w-1/2 rounded-md bg-white p-8 pb-4 shadow-md md:w-full md:p-4">
          <h2 className="text-18 text-red font-bold">Visit & Read</h2>
          <LineChart />
        </div>
      </div>
    </div>
